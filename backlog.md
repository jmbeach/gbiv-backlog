...
- [gbv-9p1] [parent:gbv-q3t] Orchestration module skeleton in the gbiv binary + tracing + tmux driver
...
- [gbv-p4n] Need a way to go beyond the 7 named worktrees if necessary. (see ./items/gbv-p4n.md)
